<h1 style="font-size:44px; font-weight:800;">Fire &amp; Smoke Detection System</h1>
...
A full demonstration video of the project is included in this repository's file listing above (`fire and somke detection vedio.mp4`). It can be viewed directly from the repository page or downloaded from there.
